...
module.exports = {
  run: async (bot, msg, args, db) => {
    if (!(msg.author.permissions.has("BAN_MEMBERS") && msg.author.permissions.has("KICK_MEMBERS"))) if (msg.author.tag !== "Splatterxl#8999") {} else return msg.reply(embeds.userPermissionMissing("perm:(kick&&ban)_members"));
