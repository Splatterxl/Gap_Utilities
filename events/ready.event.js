...
module.exports = {
    ...
    */
    run: async (bot, db) =>
    {
        ...
        // @ts-ignore
        global.voidbots = new (require('voidbots'))(process.env.VB_AUTH_TOKEN_EUREKA, {
